      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <input
              type="text" required placeholder="e.g. Build login screen"
              value={form.title}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
            <div>
              ...
              <select
                required value={form.project_id}
                onChange={e => setForm({ ...form, project_id: e.target.value })}
                style={{ ...inputStyle, color: form.project_id ? '#fff' : '#555' }}
              >
            ...
            <div>
              ...
              <select
                ...
                style={{ ...inputStyle, color: form.assigned_to ? '#fff' : '#555' }}
              >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
            ...
            <div>
              ...
              <input
                ...
                style={{ width: '100%', marginTop: '14px', accentColor: '#a3e635' }}
              />
            </div>
          </div>
